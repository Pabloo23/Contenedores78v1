...
public class EjemploJPanel extends JFrame implements ActionListener {
    ...
    void creadorPanelCentral() {
        ...
        panelC = new JPanel();
        BoxLayout panelCLay = new BoxLayout(panelC, BoxLayout.LINE_AXIS);
        
        panelC.setLayout(panelCLay);
        ...
        panelC.add(panelCi);
        panelC.add(Box.createHorizontalStrut(25));
        panelC.add(panelCd);
    }
    ...
    void creadorPanelSur() {
        ...
        boton2 = new JButton(" Visible ");
        boton2.setName("boton2");
        boton2.addActionListener(this);
        boton3 = new JButton(" No Visible ");
